...
export default function BottomNav({ currentPage, goTo, currentUser, unreadCount, onOpenMessages }) {
  const ic = (active, paths) => (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="none"
      stroke={active ? 'white' : 'rgba(255,255,255,0.42)'}
      strokeWidth="2"
      strokeLinecap="round"
  ...
  const tabs = [
    ...
    },
    {
      ...
      label: 'Postfach',
      icon: (a) =>
        ic(a, <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />),
    },
    {
  ...
  return (
    <nav
      ...
      style={{
        ...
        right: '0.75rem',
        zIndex: 900,
        background: 'linear-gradient(135deg, #163126 0%, #1C3A2E 100%)',
        borderRadius: 22,
        boxShadow: '0 16px 48px rgba(28,58,46,0.5), 0 4px 16px rgba(0,0,0,0.18)',
      }}
    >
            ...
            >
              ...
              <span
                style={{
                  ...
                  color: isActive ? C.terra : 'rgba(255,255,255,0.42)',
