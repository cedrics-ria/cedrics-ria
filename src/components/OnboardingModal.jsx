...
export default function OnboardingModal({ user, onClose, goTo }) {
  return (
    <div role="presentation" style={{ position: "fixed", inset: 0, zIndex: 9000, background: "rgba(0,0,0,0.55)", backdropFilter: "blur(10px)", display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem", animation: "fadeUp 0.3s ease" }}>
      <div role="dialog" aria-modal="true" aria-labelledby="onboarding-title" style={{ background: "white", borderRadius: 28, padding: "2.5rem", maxWidth: 520, width: "100%", boxShadow: "0 40px 80px rgba(0,0,0,0.25)", animation: "fadeUp 0.4s 0.1s both", textAlign: "center" }}>
        ...
        <h2 id="onboarding-title" style={{ color: "#1C3A2E", fontSize: "1.9rem", marginTop: 0, marginBottom: "0.75rem", letterSpacing: "-0.03em" }}>Hey {user?.name?.split(" ")[0]}!</h2>
